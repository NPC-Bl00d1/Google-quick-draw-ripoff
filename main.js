...
function gotResult(error, results){
    ...
    document.getElementById("sketchguess").innerHTML = "Sketch is: " + results[0].label;
    
    document.getElementById("sketchconfidence").innerHTML = "Confidence is: " + Math.round(results[0].confidence * 100) + "%";
